...
export function serveStatic(app: Express) {
  ...
  // So we need to go to ./public from the server's directory
  const distPath = path.resolve(import.meta.dirname, "public");
  
  console.log(`[Static Files] Current directory: ${import.meta.dirname}`);
  ...
  if (!fs.existsSync(distPath)) {
    ...
    console.error(`Files in current dir:`, fs.readdirSync(parentDir));
  }
